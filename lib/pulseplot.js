...
class Pulseplot {
    ...
    */
    ...
    /**
        ...
        @param {string} [options.hiFill='rgba(187,0,187,0.2)'] - Mark fill color
        @param {number} [options.hiLine=3] - Mark line width
        @param {string} [options.loStroke='#c33'] - Space stroke color
        @param {string} [options.loFill='rgba(153,153,153,0.2)'] - Space fill color
    ...
    */
    setTheme(options) {
        let defaults = {
            hiStroke: '#3c3',
            hiFill: 'rgba(187,0,187,0.2)',
            hiLine: 3,
            loStroke: '#c33',
            loFill: 'rgba(153,153,153,0.2)',
            loLine: 3,
            edgeStroke: '#ccc',
            edgeLine: 1,
            textFill: '#666',
    ...
    */
    enableScrollZoom() {
        ...
        let events = ['mousedown', 'mousemove', 'mouseup', 'wheel', 'dblclick']
